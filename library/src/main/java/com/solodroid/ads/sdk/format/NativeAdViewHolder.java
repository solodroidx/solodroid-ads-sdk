...
public class NativeAdViewHolder extends RecyclerView.ViewHolder {
    ...
    public void loadNativeAd(Context context, String adStatus, int placementStatus, String adNetwork, String backupAdNetwork, String adMobNativeId, String adManagerNativeId, String appLovinNativeId, boolean darkTheme, boolean legacyGDPR, String nativeStyles) {
                            ...
                            AdLoader adLoader = new AdLoader.Builder(context, adMobNativeId)
                                    ...
                                    .withAdListener(new AdListener() {
                                        ...
                                        public void onAdFailedToLoad(@NonNull LoadAdError adError) {
                                            loadBackupNativeAd(context, adStatus, placementStatus, backupAdNetwork, adMobNativeId, adManagerNativeId, appLovinNativeId, darkTheme, legacyGDPR, nativeStyles);
                                        }
                                    })
                                    .build();
    ...
    public void loadBackupNativeAd(Context context, String adStatus, int placementStatus, String backupAdNetwork, String adMobNativeId, String adManagerNativeId, String appLovinNativeId, boolean darkTheme, boolean legacyGDPR, String nativeStyles) {
        if (adStatus.equals(AD_STATUS_ON)) {
            if (placementStatus != 0) {
